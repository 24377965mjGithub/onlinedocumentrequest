      ...
      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <section class="sample">
            <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Student Tracker Dashboard</h4>
                    <p>
                        Welcome to your personalized Student Tracker Dashboard! <br> Here, you can effortlessly monitor the progress of your document requests. <br> Your convenience is our priority, so let's dive in and streamline your journey
                    </p>
                                ...
                                <tr>
                                    <td>
                                        <p>
                                            ...
                                            <b>Date: </b>{{ $req->created_at->format('l, F j, Y') }}
                                        </p>
                                    </td>
                                    <td>
                                        <a href="{{ url('track-request/'.$req->id) }}">
                                            <button class="btn btn-info">Track Request</button>
                                        </a>
